...
public class MaterializedViewUtils
{
    ...
    public static void validateMaterializedViewQuery(Query viewQuery)
    {
        new MaterializedViewPlanValidator(viewQuery).validate();
    }
    ...
    public static Map<String, Map<SchemaTableName, String>> computeMaterializedViewToBaseTableColumnMappings(Query viewQuery, Analysis analysis)
    {
        ...
        List<List<TableColumn>> linkedBaseColumns = new MaterializedViewPlanValidator(viewQuery).getLinkedBaseColumns(analysis);
