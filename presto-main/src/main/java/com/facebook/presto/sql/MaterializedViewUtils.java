...
public class MaterializedViewUtils
{
    ...
    public static void validateMaterialziedViewQueryPlan(Statement query)
    {
    ...
    public static Map<String, Map<SchemaTableName, String>> computeMaterializedViewToBaseTableColumnMappings(Query viewQuery, Analysis analysis)
    {
        ...
        Map<String, Map<SchemaTableName, String>> originalColumnMapping = analysis.getOriginalColumnMapping(viewQuery);

        MaterializedViewPlanValidator planAnalyzer = new MaterializedViewPlanValidator(viewQuery, false, Optional.of(analysis));
