        ...
        extends AbstractTestQueries
{
    ...
    public void testRefreshMaterializedViewAccessControl()
    {
        ...
        // Verify that refreshing checks the owner's permission instead of the invoker's permission on the base table
        assertAccessDenied(
                invokerSession,
        ...
        // Verify that refreshing checks owner's permission instead of the invokers permission on the materialized view.
        // Verify that refreshing requires INSERT_TABLE permission instead of SELECT_COLUMN permission on the materialized view.
        assertAccessDenied(
                invokerSession,
                refreshMaterializedView,
