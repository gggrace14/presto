...
public class QueryRewriter
{
    ...
    {
        return rewriteQuery(query, queryConfiguration, clusterType, true);
    }
    ...
    public QueryObjectBundle rewriteQuery(@Language("SQL") String query, QueryConfiguration queryConfiguration, ClusterType clusterType, boolean reuseTable)
    {
        ...
        boolean shouldReuseTable = reuseTable && reuseTables.get(clusterType) && queryConfiguration.getClientTags().contains(QueryConfiguration.CLIENT_TAG_OUTPUT_REUSABLE);
