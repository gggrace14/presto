...
class PrestoNoCommitWriteProtocol
 ...
 public:
  ...
  static void registerProtocol() {
    registerWriteProtocol(std::make_shared<PrestoNoCommitWriteProtocol>());
  }
...
class PrestoTaskCommitWriteProtocol
 ...
 public:
  ~PrestoTaskCommitWriteProtocol() override {}
  ...
  static void registerProtocol() {
    registerWriteProtocol(std::make_shared<PrestoTaskCommitWriteProtocol>());
  }
